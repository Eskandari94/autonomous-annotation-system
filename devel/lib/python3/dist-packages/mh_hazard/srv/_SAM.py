...
"""autogenerated by genpy from mh_hazard/SAMRequest.msg. Do not edit."""
import codecs
import sys
...
class SAMRequest(genpy.Message):
  _md5sum = "5c1b1966339d79189f8ace1333034d63"
  _type = "mh_hazard/SAMRequest"
...
string frame_id
"""
  __slots__ = ['image','target_x','target_y']
  _slot_types = ['sensor_msgs/Image','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SAMRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2i().pack(_x.target_x, _x.target_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.target_x, _x.target_y,) = _get_struct_2i().unpack(str[start:end])
      return self
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from mh_hazard/SAMResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class SAMResponse(genpy.Message):
  _md5sum = "8968aac62e5b42522320740dd001fbce"
  _type = "mh_hazard/SAMResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """sensor_msgs/Image[]  masks
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SAMResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
class SAM(object):
  _type          = 'mh_hazard/SAM'
  _md5sum = '91a25104efa47a7b7732744e46f4e2e9'
  _request_class  = SAMRequest
  _response_class = SAMResponse
