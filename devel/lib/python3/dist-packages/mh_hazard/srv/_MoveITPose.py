...
"""autogenerated by genpy from mh_hazard/MoveITPoseRequest.msg. Do not edit."""
import codecs
import sys
...
class MoveITPoseRequest(genpy.Message):
  _md5sum = "3f8930d968a3e84d471dff917bb1cdae"
  _type = "mh_hazard/MoveITPoseRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveITPoseRequest, self).__init__(*args, **kwds)
...
def _get_struct_7d():
    ...
    return _struct_7d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from mh_hazard/MoveITPoseResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class MoveITPoseResponse(genpy.Message):
  _md5sum = "eb13ac1f1354ccecb7941ee8fa2192e8"
  _type = "mh_hazard/MoveITPoseResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveITPoseResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    return _struct_B
class MoveITPose(object):
  _type          = 'mh_hazard/MoveITPose'
  _md5sum = '1d4e3f01f751b136dce2bc699f1d7748'
  _request_class  = MoveITPoseRequest
  _response_class = MoveITPoseResponse
