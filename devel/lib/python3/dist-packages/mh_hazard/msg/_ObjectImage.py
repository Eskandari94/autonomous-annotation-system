...
"""autogenerated by genpy from mh_hazard/ObjectImage.msg. Do not edit."""
import codecs
import sys
...
class ObjectImage(genpy.Message):
  _md5sum = "534258c07e4a1a1800266e633173bfd7"
  _type = "mh_hazard/ObjectImage"
...
float64 z
"""
  __slots__ = ['header','image','object_positions']
  _slot_types = ['std_msgs/Header','sensor_msgs/Image','geometry_msgs/Point[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ObjectImage, self).__init__(*args, **kwds)
