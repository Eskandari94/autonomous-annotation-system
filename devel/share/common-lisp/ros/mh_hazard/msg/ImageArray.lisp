...
(cl:defmethod cl:initialize-instance :after ((m <ImageArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ImageArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mh_hazard-msg:<ImageArray> is deprecated: use mh_hazard-msg:ImageArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ImageArray>))
...
(cl:defmethod images-val ((m <ImageArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mh_hazard-msg:images-val is deprecated.  Use mh_hazard-msg:images instead.")
  (images m))
